  ...
  if( restart_file == "none" )
    {
      ...
      libMesh::Real T_init = libMesh_inputfile("Materials/Gas/ReferenceTemperature/value", 0.0);
      libMesh::Real p0_init = libMesh_inputfile("Materials/Gas/ThermodynamicPressure/value", 0.0);
